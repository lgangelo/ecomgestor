...
export const PERMISSIONS = {
  ...
  // Granulares da integração Mercado Livre (esqueleto — ver docs/integrations/mercado-livre.md).
  // Mesmo raciocínio da Shopee: SYNC reservada, ainda sem job de sincronização real.
  INTEGRATION_MERCADOLIVRE_READ: 'integration.mercadolivre.read',
  INTEGRATION_MERCADOLIVRE_CONNECT: 'integration.mercadolivre.connect',
  INTEGRATION_MERCADOLIVRE_SYNC: 'integration.mercadolivre.sync',
...
export const DEFAULT_ROLE_PERMISSIONS: Record<RoleName, PermissionKey[]> = {
  ...
  MANAGER: [
    ...
    PERMISSIONS.INTEGRATION_MERCADOLIVRE_READ,
    PERMISSIONS.INTEGRATION_MERCADOLIVRE_CONNECT,
    PERMISSIONS.INTEGRATION_MERCADOLIVRE_SYNC,
